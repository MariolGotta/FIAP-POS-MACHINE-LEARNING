...
class TestInvestimentos(unittest.TestCase):
    ...
    def test_calcular_juros_compostos(self):
        self.assertAlmostEqual(calcular_juros_compostos(
            1000, 6, 5), 1338.23, places=2)

    def test_converter_taxa_anual_para_mensal(self):
        self.assertAlmostEqual(converter_taxa_anual_para_mensal(
            12), 0.9487, places=3)  # Alterado de places=4 para places=3
