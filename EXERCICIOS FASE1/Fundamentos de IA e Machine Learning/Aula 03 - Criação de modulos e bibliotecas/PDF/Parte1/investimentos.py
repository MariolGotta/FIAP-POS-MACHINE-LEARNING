...
def converter_taxa_anual_para_mensal(taxa_anual):
    """
    Converte uma taxa de juros anual para uma taxa mensal equivalente.

    Args:
        taxa_anual (float): Taxa de juros anual em porcentagem.

    Returns:
        float: Taxa de juros mensal equivalente em porcentagem.
    """
    taxa_decimal_anual = taxa_anual / 100
    taxa_mensal_decimal = (1 + taxa_decimal_anual) ** (1 / 12) - 1
